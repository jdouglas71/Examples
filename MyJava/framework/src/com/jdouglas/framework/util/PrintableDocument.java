...
{
	/** Module Name */
    private static final String MODULE_NAME                                                         = "PrintableDocument.";

    /** The root View to be printed */
    private View root;              
    /** Paper plus page orientation */
    private PageFormat format;      
    /** How much to scale before printing */
    ...
    */
    public PageFormat getPageFormat(int pagenum)
    {
        ...
        double pageLength = pageLengths.get(pagenum).doubleValue();
    ...
    */
    public int print(Graphics g, PageFormat format, int pageIndex)
    {
        ...
        if( pageIndex > 0 )
            pageStart = pageOffsets.get(pageIndex-1).doubleValue();
        if( pageIndex < numPages-1 )
            pageLength = pageLengths.get(pageIndex).doubleValue();
    ...
    */
    static class ParentView 
        extends View
    {
        private static final String MODULE_NAME                                                         = "ParentView.";
