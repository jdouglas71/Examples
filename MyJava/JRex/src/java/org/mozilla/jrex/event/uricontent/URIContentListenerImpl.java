...
public class URIContentListenerImpl implements URIContentListener{
	public boolean onStartContent(URIContentEvent event){
		System.err.println("TEST  onStartContent"+event);
		return false;
	}

	public URIContentEventRV doContent(URIContentEvent event){
		System.err.println("TEST doContent "+event);
		return null;
	}

	public URIContentEventRV isContentPreferred(URIContentEvent event){
		System.err.println("TEST isContentPreferred "+event);
		return null;
	}
	public URIContentEventRV canHandleContent(URIContentEvent event){
		System.err.println("TEST  canHandleContent"+event);
		return null;
	}
}