...
public class WindowEvent{
	...
	private static final String className = WindowEvent.class.getName();
	...
	* @param eventType  type of window event
	* @param eventParam  data associated to the window event
	* @see WindowEventConstants
	*/
	public WindowEvent(int jrexPeer,int eventType,Object eventParam){
		if(JRexL.on)
			JRexL.log(className,"**** WindowEvent()-->jrexPeer<"+jrexPeer+
