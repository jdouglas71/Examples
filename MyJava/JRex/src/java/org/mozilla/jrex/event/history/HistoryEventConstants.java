...
public interface HistoryEventConstants{
	...
	*/
	public static final short HIS_NEW_ENTRY_EVENT	= 0;

	/**
	* GoBack history event type.
	*/
	public static final short HIS_GO_BACK_EVENT		= 1;

	/**
	* GoForward history event type.
	*/
	public static final short HIS_GO_FORWARD_EVENT	= 2;

	/**
	* Reload event type.
	*/
	public static final short HIS_RELOAD_EVENT		= 3;

	/**
	* GoToIndex history event type.
	*/
	public static final short HIS_GO_TO_INDEX_EVENT	= 4;

	/**
	* purge history entries event type.
	*/
	public static final short HIS_PURGE_EVENT		= 5;
}