...
* @version 1.0
* @see org.w3c.dom.html2.HTMLParagraphElement
*/

public class JRexHTMLParagraphElementImpl extends JRexHTMLElementImpl implements HTMLParagraphElement {

	private static final String className	= JRexHTMLParagraphElementImpl.class.getName();

     /** Intended to be used by JNI */
    private JRexHTMLParagraphElementImpl() {
		if(JRexL.on)JRexL.log(className,"**** JRexHTMLParagraphElementImpl ****");
	}
