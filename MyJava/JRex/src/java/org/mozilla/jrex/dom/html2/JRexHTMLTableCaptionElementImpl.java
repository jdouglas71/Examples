...
* @version 1.0
* @see org.w3c.dom.html2.HTMLTableCaptionElement
*/
public class JRexHTMLTableCaptionElementImpl extends JRexHTMLElementImpl implements HTMLTableCaptionElement {
	private static final String className	= JRexHTMLTableCaptionElementImpl.class.getName();

	/** Intended to be used by JNI */
    private JRexHTMLTableCaptionElementImpl() {
		if(JRexL.on)JRexL.log(className,"**** JRexHTMLTableCaptionElementImpl ****");
	}
