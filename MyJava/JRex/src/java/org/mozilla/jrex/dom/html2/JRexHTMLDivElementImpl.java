...
* @version 1.0
* @see org.w3c.dom.html2.HTMLDivElement
*/

public class JRexHTMLDivElementImpl extends JRexHTMLElementImpl implements HTMLDivElement {

	private static final String className	= JRexHTMLDivElementImpl.class.getName();

     /** Intended to be used by JNI */
    private JRexHTMLDivElementImpl() {
		if(JRexL.on)JRexL.log(className,"**** JRexHTMLDivElementImpl ****");
	}
