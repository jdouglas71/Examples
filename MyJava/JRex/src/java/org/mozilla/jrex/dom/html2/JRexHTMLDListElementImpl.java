...
* @version 1.0
* @see org.w3c.dom.html2.HTMLDListElement
*/

public class JRexHTMLDListElementImpl extends JRexHTMLElementImpl implements HTMLDListElement {

	private static final String className	= JRexHTMLDListElementImpl.class.getName();

     /** Intended to be used by JNI */
    private JRexHTMLDListElementImpl() {
		if(JRexL.on)JRexL.log(className,"**** JRexHTMLDListElementImpl ****");
	}
