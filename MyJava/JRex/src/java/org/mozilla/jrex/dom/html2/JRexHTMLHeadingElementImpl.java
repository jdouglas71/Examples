...
* @version 1.0
* @see org.w3c.dom.html2.HTMLHeadingElement
*/

public class JRexHTMLHeadingElementImpl extends JRexHTMLElementImpl implements HTMLHeadingElement {

	private static final String className	= JRexHTMLHeadingElementImpl.class.getName();

     /** Intended to be used by JNI */
    private JRexHTMLHeadingElementImpl() {
		if(JRexL.on)JRexL.log(className,"**** JRexHTMLHeadingElementImpl ****");
	}
