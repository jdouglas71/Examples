...
* @version 1.0
* @see org.w3c.dom.html2.HTMLTitleElement
*/

public class JRexHTMLTitleElementImpl extends JRexHTMLElementImpl implements HTMLTitleElement {

	private static final String className	= JRexHTMLTitleElementImpl.class.getName();

     /** Intended to be used by JNI */
    private JRexHTMLTitleElementImpl() {
		if(JRexL.on)JRexL.log(className,"**** JRexHTMLTitleElementImpl ****");
	}
