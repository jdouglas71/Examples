...
* @version 1.0
* @see org.w3c.dom.html2.HTMLDirectoryElement
*/

public class JRexHTMLDirectoryElementImpl extends JRexHTMLElementImpl implements HTMLDirectoryElement {

	private static final String className	= JRexHTMLDirectoryElementImpl.class.getName();

     /** Intended to be used by JNI */
    private JRexHTMLDirectoryElementImpl() {
		if(JRexL.on)JRexL.log(className,"**** JRexHTMLDirectoryElementImpl ****");
	}
