...
* @version 1.0
* @see org.w3c.dom.html2.HTMLFontElement
*/

public class JRexHTMLFontElementImpl extends JRexHTMLElementImpl implements HTMLFontElement {

	private static final String className	= JRexHTMLFontElementImpl.class.getName();

     /** Intended to be used by JNI */
    private JRexHTMLFontElementImpl() {
		if(JRexL.on)JRexL.log(className,"**** JRexHTMLFontElementImpl ****");
	}
