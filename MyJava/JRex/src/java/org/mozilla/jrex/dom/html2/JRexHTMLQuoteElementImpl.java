...
* @version 1.0
* @see org.w3c.dom.html2.HTMLQuoteElement
*/

public class JRexHTMLQuoteElementImpl extends JRexHTMLElementImpl implements HTMLQuoteElement {

	private static final String className	= JRexHTMLQuoteElementImpl.class.getName();

     /** Intended to be used by JNI */
    private JRexHTMLQuoteElementImpl() {
		if(JRexL.on)JRexL.log(className,"**** JRexHTMLQuoteElementImpl ****");
	}
