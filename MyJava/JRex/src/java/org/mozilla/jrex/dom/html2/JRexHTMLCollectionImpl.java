...
* @version 1.0
* @see org.w3c.dom.html2.HTMLCollection
*/

public class JRexHTMLCollectionImpl implements HTMLCollection {

	private static final String className	= JRexHTMLCollectionImpl.class.getName();

	private int peerHTMLCol=0;

     /** Intended to be used by JNI */
    private JRexHTMLCollectionImpl() {
		if(JRexL.on)JRexL.log(className,"**** JRexHTMLCollectionImpl ****");
	}
    ...
    public boolean equals(Object obj) {
		return (obj instanceof JRexHTMLCollectionImpl)?this.peerHTMLCol==((JRexHTMLCollectionImpl)obj).peerHTMLCol:false;
    }
