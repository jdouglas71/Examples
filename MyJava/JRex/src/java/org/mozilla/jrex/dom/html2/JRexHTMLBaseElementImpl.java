...
* @version 1.0
* @see org.w3c.dom.html2.HTMLBaseElement
*/

public class JRexHTMLBaseElementImpl extends JRexHTMLElementImpl implements HTMLBaseElement {

	private static final String className	= JRexHTMLBaseElementImpl.class.getName();

     /** Intended to be used by JNI */
    private JRexHTMLBaseElementImpl() {
		if(JRexL.on)JRexL.log(className,"**** JRexHTMLBaseElementImpl ****");
	}
