...
* @version 1.0
* @see org.w3c.dom.html2.HTMLFieldSetElement
*/

public class JRexHTMLFieldSetElementImpl extends JRexHTMLElementImpl implements HTMLFieldSetElement {

	private static final String className	= JRexHTMLFieldSetElementImpl.class.getName();

     /** Intended to be used by JNI */
    private JRexHTMLFieldSetElementImpl() {
		if(JRexL.on)JRexL.log(className,"**** JRexHTMLFieldSetElementImpl ****");
	}
