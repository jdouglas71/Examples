...
/**
* A class implementing org.w3c.dom.Notation interface.
* @author <a href="mailto:jrex_moz@yahoo.com">C.N.Medappa</a>
* @version 1.0
* @see org.w3c.dom.Notation
*/

public class JRexNotationImpl extends JRexNodeImpl implements Notation {

	private static final String className	= JRexNotationImpl.class.getName();

     /** Intended to be used by JNI */
    private JRexNotationImpl() {
		if(JRexL.on)JRexL.log(className,"**** JRexNotationImpl ****");
	}
