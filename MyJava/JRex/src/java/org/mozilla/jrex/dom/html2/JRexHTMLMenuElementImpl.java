...
* @version 1.0
* @see org.w3c.dom.html2.HTMLMenuElement
*/

public class JRexHTMLMenuElementImpl extends JRexHTMLElementImpl implements HTMLMenuElement {

	private static final String className	= JRexHTMLMenuElementImpl.class.getName();

     /** Intended to be used by JNI */
    private JRexHTMLMenuElementImpl() {
		if(JRexL.on)JRexL.log(className,"**** JRexHTMLMenuElementImpl ****");
	}
