...
public interface Range {
     ...
     * @param refNode <code>refNode</code> value. This parameter must be
     *   different from <code>null</code>.
     * @param offset <code>startOffset</code> value.
     ...
     * @param refNode <code>refNode</code> value. This parameter must be
     *   different from <code>null</code>.
     * @param offset <code>endOffset</code> value.
     * @exception RangeException
     *   INVALID_NODE_TYPE_ERR: Raised if <code>refNode</code> or an ancestor
     *   of <code>refNode</code> is an Entity, Notation, or DocumentType
     *   node.
     ...
     * @param refNode starts before <code>refNode</code>
     * @exception RangeException
     ...
     * @param refNode starts after <code>refNode</code>
     * @exception RangeException
     *   INVALID_NODE_TYPE_ERR: Raised if the root container of
     *   <code>refNode</code> is not an Attr, Document, or DocumentFragment
     *   node or if <code>refNode</code> is a Document, DocumentFragment,
     ...
     * @param refNode ends before <code>refNode</code>
     * @exception RangeException
     *   INVALID_NODE_TYPE_ERR: Raised if the root container of
     *   <code>refNode</code> is not an Attr, Document, or DocumentFragment
     *   node or if <code>refNode</code> is a Document, DocumentFragment,
     ...
     * @param refNode ends after <code>refNode</code>.
     * @exception RangeException
     *   INVALID_NODE_TYPE_ERR: Raised if the root container of
     *   <code>refNode</code> is not an Attr, Document or DocumentFragment
     *   node or if <code>refNode</code> is a Document, DocumentFragment,
     ...
     * @param sourceRange <code>Range</code> on which this current
     ...
     * @param newNode node to insert at the start of the Range
     * @exception DOMException
     ...
     * @param newParent node to surround the contents with.
     * @exception DOMException
