...
//    }
  ...
  //    native String[]                         listProperties();
    ...
    public static JSObject getWindow(Applet applet) throws JSException {
        // This code is copied from the Java plugin for jdk 1.4.2. It is
        // required in order for LiveConnect to still work between an
        // applet and the javascript for the browser.
	try
	{
	    if (applet != null)
	    {
...
//		if (obj != null && (obj.equals("") || (new Boolean(obj).booleanValue() == true)))
	...
	{
	    JSException err = new JSException(e.getMessage());
        err.initCause(e);
        throw err;
	}
